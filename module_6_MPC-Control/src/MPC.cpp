 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (unsigned int t = 1; t < N; t++) {
      ...
      // why 3 coordinates for coeffs as opposed to 1 in quiz? Because in quiz we were fitting a first order polynomial and here we are fitting a third order polynomial
